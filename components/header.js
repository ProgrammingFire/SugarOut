...
export default function Header() {
  return (
    <nav class="flex justify-between dark:bg-nav-dark items-center bg-nav-light text-black nav-shadow dark:text-dark p-3 py-5 sticky top-0 w-full z-50">
      <div>
        <h1 class="font-mono italic font-bold text-2xl cursor-pointer hover:text-blue-400 transition-colors ml-3">
          <Link href="/">
            <Image width="180" height="50" src="/logo-1.png" />
          </Link>
        </h1>
