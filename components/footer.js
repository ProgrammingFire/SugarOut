...
export default function Footer() {
  return (
    <footer class="bg-blue-900 text-semibold flex-col py-20 text-xl flex items-center text-white w-full">
      <h1>
        Find An Issue?{" "}
        <a
      ...
      <h1 class="mt-6 flex items-center flex-col">
        <span className="">Follow Us On:</span>
        <div className="mt-2 flex gap-3 text-3xl">
        ...
        <span className="mt-3">
          787, Kaila Bhatta, Lalten Factory, Ghaziabad
        </span>
      </h1>
    </footer>
  );
